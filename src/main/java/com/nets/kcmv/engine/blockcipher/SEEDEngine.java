...
public class SEEDEngine
{
    ...
    private static final int ENDIAN = BIG_ENDIAN;
    ...
    public void setKey(byte[] userKey)
    {
        ...
        RoundKeyUpdate0(T, roundKeys, 0, ABCD, KC0);
        RoundKeyUpdate1(T, roundKeys, 2, ABCD, KC1);
        RoundKeyUpdate0(T, roundKeys, 4, ABCD, KC2);
        RoundKeyUpdate1(T, roundKeys, 6, ABCD, KC3);
        RoundKeyUpdate0(T, roundKeys, 8, ABCD, KC4);
        RoundKeyUpdate1(T, roundKeys, 10, ABCD, KC5);
        RoundKeyUpdate0(T, roundKeys, 12, ABCD, KC6);
        RoundKeyUpdate1(T, roundKeys, 14, ABCD, KC7);
        RoundKeyUpdate0(T, roundKeys, 16, ABCD, KC8);
        RoundKeyUpdate1(T, roundKeys, 18, ABCD, KC9);
        RoundKeyUpdate0(T, roundKeys, 20, ABCD, KC10);
        RoundKeyUpdate1(T, roundKeys, 22, ABCD, KC11);
        RoundKeyUpdate0(T, roundKeys, 24, ABCD, KC12);
        RoundKeyUpdate1(T, roundKeys, 26, ABCD, KC13);
        RoundKeyUpdate0(T, roundKeys, 28, ABCD, KC14);

        T[0] = ABCD[ABCD_A] + ABCD[ABCD_C] - KC15;
        T[1] = ABCD[ABCD_B] - ABCD[ABCD_D] + KC15;

        roundKeys[30] = SS0[GetB0(T[0]) & 0x0ff] ^ SS1[GetB1(T[0]) & 0x0ff] ^ SS2[GetB2(T[0]) & 0x0ff] ^ SS3[GetB3(T[0]) & 0x0ff];
    ...
    public void encrypt(byte[] in, int inOff, byte[] out, int outOff)
    {
        ...
        SeedRound(T, LR, 0, 1, 2, 3, roundKeys, 0);
        SeedRound(T, LR, 2, 3, 0, 1, roundKeys, 2);
        SeedRound(T, LR, 0, 1, 2, 3, roundKeys, 4);
        SeedRound(T, LR, 2, 3, 0, 1, roundKeys, 6);
        SeedRound(T, LR, 0, 1, 2, 3, roundKeys, 8);
        SeedRound(T, LR, 2, 3, 0, 1, roundKeys, 10);
        SeedRound(T, LR, 0, 1, 2, 3, roundKeys, 12);
        SeedRound(T, LR, 2, 3, 0, 1, roundKeys, 14);
        SeedRound(T, LR, 0, 1, 2, 3, roundKeys, 16);
        SeedRound(T, LR, 2, 3, 0, 1, roundKeys, 18);
        SeedRound(T, LR, 0, 1, 2, 3, roundKeys, 20);
        SeedRound(T, LR, 2, 3, 0, 1, roundKeys, 22);
        SeedRound(T, LR, 0, 1, 2, 3, roundKeys, 24);
        SeedRound(T, LR, 2, 3, 0, 1, roundKeys, 26);
        SeedRound(T, LR, 0, 1, 2, 3, roundKeys, 28);
        SeedRound(T, LR, 2, 3, 0, 1, roundKeys, 30);
    ...
    public void decrypt(byte[] in, int inOff, byte[] out, int outOff)
    {
        ...
        SeedRound(T, LR, 0, 1, 2, 3, roundKeys, 30);
        SeedRound(T, LR, 2, 3, 0, 1, roundKeys, 28);
        SeedRound(T, LR, 0, 1, 2, 3, roundKeys, 26);
        SeedRound(T, LR, 2, 3, 0, 1, roundKeys, 24);
        SeedRound(T, LR, 0, 1, 2, 3, roundKeys, 22);
        SeedRound(T, LR, 2, 3, 0, 1, roundKeys, 20);
        SeedRound(T, LR, 0, 1, 2, 3, roundKeys, 18);
        SeedRound(T, LR, 2, 3, 0, 1, roundKeys, 16);
        SeedRound(T, LR, 0, 1, 2, 3, roundKeys, 14);
        SeedRound(T, LR, 2, 3, 0, 1, roundKeys, 12);
        SeedRound(T, LR, 0, 1, 2, 3, roundKeys, 10);
        SeedRound(T, LR, 2, 3, 0, 1, roundKeys, 8);
        SeedRound(T, LR, 0, 1, 2, 3, roundKeys, 6);
        SeedRound(T, LR, 2, 3, 0, 1, roundKeys, 4);
        SeedRound(T, LR, 0, 1, 2, 3, roundKeys, 2);
        SeedRound(T, LR, 2, 3, 0, 1, roundKeys, 0);
    ...
    private void int_to_int_array(int[] dst, byte[] src, int src_offset)
    {
        dst[0] = byte_to_int(src, src_offset, ENDIAN);
        dst[1] = byte_to_int(src, src_offset + 4, ENDIAN);
        dst[2] = byte_to_int(src, src_offset + 8, ENDIAN);
        dst[3] = byte_to_int(src, src_offset + 12, ENDIAN);
    }

    private void int_array_to_byte(byte[] dst, int dst_offset, int[] src, int... order)
    {
        int_to_byte_unit(dst, dst_offset, src[order[0]], ENDIAN);
        int_to_byte_unit(dst, dst_offset + 4, src[order[1]], ENDIAN);
        int_to_byte_unit(dst, dst_offset + 8, src[order[2]], ENDIAN);
