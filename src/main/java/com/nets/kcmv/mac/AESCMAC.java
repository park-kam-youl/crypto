...
public class AESCMAC extends MacSpi {
    ...
    public AESCMAC() {
        this.engine = new com.nets.kcmv.engine.blockcipher.AESEngine();
    }
    ...
    protected void engineInit(Key key, AlgorithmParameterSpec params) throws InvalidKeyException, java.security.InvalidAlgorithmParameterException {
        ...
        if (params != null) {
            throw new java.security.InvalidAlgorithmParameterException("AES-CMAC does not use parameters");
        }
        ...
        try {
            ...
            throw new InvalidKeyException("Error during subkey generation", e);
        }
    ...
    private void processBlock(byte[] in, int inOff) {
        ...
        try {
            ...
            throw new IllegalStateException("Error during CMAC block processing", e);
        }
    }
