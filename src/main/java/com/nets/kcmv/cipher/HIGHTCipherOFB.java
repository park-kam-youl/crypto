...
public class HIGHTCipherOFB extends CipherSpi
{
    ...
    protected void engineInit(int opmode, Key key, AlgorithmParameterSpec params, SecureRandom random) throws InvalidKeyException, InvalidAlgorithmParameterException
    {
        ...
        engine.init(HIGHTEngine.Mode.ENCRYPT, key.getEncoded()); // OFB uses encryption engine for both encryption and decryption
        buffer.reset();
    }
